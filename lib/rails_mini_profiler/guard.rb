...
module RailsMiniProfiler
  ...
  class Guard
    ...
    # Whether or not to store profiling data
    #
    # Profiling data is stored on a per-user basis. If the user is not authorized, or hasn't been set otherwise no
    # data is stored.
    #
    # @see User
    # @return [Boolean] false if no user is present
    def store?
